...
use ethportal_api::{
    HistoryContentValue, HistoryContentKey, HistoryNetworkApiClient,
...
async fn main() -> Result<(), Box<dyn Error>> {
    ...
    // Call web3_clientVersion endpoint using `Web3ApiClient`
    ...
    assert_eq!(result, ethportal_api::PossibleHistoryContentValue::ContentPresent(content_item));
